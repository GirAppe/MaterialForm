Pod::Spec.new do |s|
    ...
    s.screenshots      = 'https://raw.githubusercontent.com/GirAppe/MaterialForm/0.9.1/material-form-light.gif', 'https://raw.githubusercontent.com/GirAppe/MaterialForm/0.9.1/material-form-dark.gif'
